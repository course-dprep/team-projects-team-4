# analysis.R
# Linear models for runtime, top_genre, and runtime × top_genre moderation
...
# Model 2: Runtime + top_genre
lm2 <- lm(averageRating ~ m_runtime + top_genre, data = IMDB_filtered)
summary(lm2)

# Model 3: Runtime × top_genre (interaction)
...
# Compact table of runtime + runtime × top_genre terms from lm3
